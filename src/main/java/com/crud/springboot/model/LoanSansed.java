...
@Entity
@Table(name = "Loan_Sanctioned")
 
public class LoanSansed {
	@Id
	@Column(name = "Loan_Sanctioned_No")
	private String loanSanctionedNo;
	...
	public String getSanctionedNo() {
		return loanSanctionedNo;
	}

	public void setSanctionedNo(String sanctionedNo) {
		this.loanSanctionedNo = sanctionedNo;
	}
